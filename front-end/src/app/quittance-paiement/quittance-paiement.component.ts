  ...
  back(){
   ...
   //console.log("yes ");
     var doc = new jsPDF();
       ...
       const dateP = this.facture.date_paiement;
       doc.text(dateP.toString(),175,55);
       doc.text('Bailleur : ',20,62);
       doc.text(this.proprietaire.civilite,20,70);
       doc.text(this.proprietaire.nom,30,70);
       doc.text(this.proprietaire.prenom,52,70);
       ...
       const loyerM = this.bien.loyer_mensuel;
       doc.text(loyerM.toString(),120,145);
       doc.text(('DH'),130,145);
       ...
       const syndic = this.bien.syndic;
       doc.text(syndic.toString(),120,155);
       doc.text(('DH'),130,155);
     
       doc.line(20,158,200,158);
       doc.setLineWidth(0.1);
       const moisP = this.facture.mois_paiement;
       doc.text('Pour le mois  ',30,165);
       doc.text(moisP.toString(),120,165);
     
       doc.line(20,168,200,168);
       doc.setLineWidth(0.1);
       const montT = this.facture.montant_total;
       doc.text('Montant total  ',30,175);
       doc.text(montT.toString(),120,175);
       doc.text(('DH'),130,145);
       ...
       doc.setLineWidth(0.1);
        ...
        doc.text(' du montant du présent terme. Elle est à conserver pendant trois ans par le locataire (article 7-1 de la loi n° ',20,198)
        doc.text('89-462 du 6 juillet 1989). 89-462 du 6 juillet 1989).',20,208)
